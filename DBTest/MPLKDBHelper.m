...
+(LKDBHelper *)getUsingLKDBHelper
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSString* dbpath = [sqlitePath stringByAppendingPathComponent:[NSString stringWithFormat:@"LKDB.db"]];
...
+ (NSString *)downloadPath{
    ...
    NSString *downloadPath = [documentPath stringByAppendingPathComponent:@"db"];
    NSLog(@"%@",downloadPath);
    return downloadPath;
}
