...
+ (UIBezierPath *)insideCorner:(CGRect)originalFrame andRadis:(CGFloat)radis andTop:(BOOL)top{
    ...
    [bezierPath moveToPoint: CGPointMake(radis,0)];
    CGPoint p1 = top?CGPointMake(radis,radis):CGPointMake(0,0);
    [bezierPath addQuadCurveToPoint:CGPointMake(0,radis) controlPoint:p1];
    [bezierPath addLineToPoint:CGPointMake(0, frame.size.height - radis)];
    CGPoint p3 = top?CGPointMake(0,frame.size.height):CGPointMake(radis,frame.size.height - radis);
    [bezierPath addQuadCurveToPoint:CGPointMake(radis,frame.size.height) controlPoint:p3];
    [bezierPath addLineToPoint:CGPointMake(frame.size.width - radis, frame.size.height)];
    CGPoint p4 = top?CGPointMake(frame.size.width, frame.size.height):CGPointMake(frame.size.width - radis, frame.size.height - radis);
    [bezierPath addQuadCurveToPoint:CGPointMake(frame.size.width, frame.size.height - radis) controlPoint:p4];
    [bezierPath addLineToPoint:CGPointMake(frame.size.width, radis)];
    CGPoint p2 = top?CGPointMake(frame.size.width - radis, radis):CGPointMake(frame.size.width, 0);
    [bezierPath addQuadCurveToPoint:CGPointMake(frame.size.width - radis,0) controlPoint:p2];
    [bezierPath addLineToPoint:CGPointMake(radis, 0)];
